...
<p align="center">
   Screeenshot last updated <b>2024-02-17</b>
</p>
...
This is my NixOS config for the Razer Book 13 using Hyprland and some tools i find usefull
...
2. **First Reboot**
   ...
   After reboot you will land in the commandline
   > Using WiFi with `nmcli device wifi connect "{YOURSSID}" password "{SSIDPASSWORD}"`
3. **Clone the repo**

   ```
   nix-shell -p git
   git clone https://github.com/Unim8trix/nixos-razerbook
   cd nixos-razerbook
   ```
4. **Install script**
...
- Nix Flakes
  - [Frost-Phoenix/nixos-config](https://github.com/Frost-Phoenix/nixos-config): This is where I start my nixos / hyprland journey.
